...
Процедура ПометитьНаУдалениеСнятьПометку(Команда)
	...
	ДополнительныеПараметры.Вставить("ЕстьПометкаУдаления", ЕстьПометкаУдаления);
	
	ОписаниеОповещения = Новый ОписаниеОповещения("ПометитьНаУдалениеСнятьПометкуЗавершение", ЭтаФорма, ДополнительныеПараметры);
...
&НаКлиенте
Процедура ПометитьНаУдалениеСнятьПометкуЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ЕстьПометкаУдаления = ДополнительныеПараметры.ЕстьПометкаУдаления;
