...
Процедура ПередЗаписью(Отказ)
	...
	//	Если ВидНоменклатуры <> Ссылка.ВидНоменклатуры И СуществуютСсылки(СуществуютСсылки)Тогда

	//		ТекстСообщения = "Номенклатура """ + СокрЛП(Ссылка) + """ .
	//						 |Вид номенклатуры не может быть изменен!";
