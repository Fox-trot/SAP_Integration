...
Функция ПечатьАктСписания()
	...
	Область.Параметры.Количество = Номенклатура.Итог("Количество");
	Область.Параметры.Сумма = Номенклатура.Итог("Сумма");
	Область.Параметры.КоличествоПрописью = ЧислоПрописью(Номенклатура.Итог("Количество"),"НД=Ложь",",,,,,,,,0");
	...
	ТабДок.АвтоМасштаб = Истина;
 	ТабДок.КлючПараметровПечати="КПП_СписаниеНоменклатурыПродаж";
...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	Возврат Новый Структура("АктСписания","Акт списания");
...
Процедура ДвиженияПоРегистрамПоУказаннойСтоимости(РежимПроведения,  Отказ, Заголовок, СтруктураШапкиДокумента)
	...
	ПроверитьОстаткиНоменклатурыПродаж(Отказ,ЭтотОбъект,Номенклатура, Склад,Организация);
