...
Процедура ПриУстановкеНовогоНомера(СтандартнаяОбработка, Префикс)
	...
	Префикс	= ?(ПустаяСтрока(Префикс), Организация.Префикс, Префикс);
...
Процедура ДвиженияПоБУ(Режим, Отказ, Заголовок ,СтруктураШапкиДокумента)
	...
	Для Каждого Платеж Из Платежи Цикл
		...
		Если Дата < Дата(2022, 1, 1) И (Платеж.ВидДвижения=Перечисления.ВидДвиженияДенежныхСредствПоВыписке.Поступление) и
