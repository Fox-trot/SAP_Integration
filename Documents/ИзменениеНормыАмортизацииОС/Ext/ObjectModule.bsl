...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого ТекСтрокаОС Из ОС Цикл
		...
		Движение.КоэффициентАмортизации = ТекСтрокаОС.КоэффициентАмортизации;
		Движение.КорректирующийКоэффициент = ТекСтрокаОС.КорректирующийКоэффициент;
		Движение.ПараметрВыработкиОС = ТекСтрокаОС.ПараметрВыработкиОС;
	КонецЦикла;
