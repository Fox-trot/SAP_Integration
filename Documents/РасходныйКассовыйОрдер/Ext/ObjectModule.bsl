...
Функция ПечатьРКО()
	...
	ОбластьМакета.Параметры.СуммаПрописью     		= СформироватьСуммуПрописью(Сумма, мВалютаРегламентированногоУчета);
...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если СокрЛП(Номер)="" Тогда
		...
		Сообщить("Документ без номера не может быть проведен");
		Отказ=Истина;
