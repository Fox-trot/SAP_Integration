...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если РасчетныйПериод<>Константы.ТекущийРасчетныйПериод.Получить() Тогда
		Отказ=истина;
		Сообщить("Для проведения документа смените расчетный период на "+Формат(РасчетныйПериод,"ДФ=MMMM.yyyy"));
	КонецЕсли; 
	Конецесли;
...
Процедура ОбработкаЗаполнения(Основание)
	Если ТипЗнч(Основание) = Тип("ДокументСсылка.ПроизвольныеРасчеты") Тогда
		...
		Если Сотрудники.Количество()=0 Тогда
			...
			Сообщить("Нет сотрудников к выплате!");
...
Процедура ОбработкаУдаленияПроведения(Отказ)
	...
	Если РасчетныйПериод<>Константы.ТекущийРасчетныйПериод.Получить() Тогда
		Отказ=истина;
		Сообщить("Для отмены проведения документа смените расчетный период на "+Формат(РасчетныйПериод,"ДФ=MMMM.yyyy"));
	КонецЕсли; 
	Конецесли;
