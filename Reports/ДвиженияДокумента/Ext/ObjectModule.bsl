...
Процедура СформироватьИВывестиОтчет() Экспорт
	...
	СформироватьОтчет(ДокументДляВывода);
	ДокументДляВывода.Показать("Движения документа " + Строка(Документ) + " по регистрам");
	
КонецПроцедуры	
	
Процедура СформироватьОтчет(РезультирующийДокумент) Экспорт
	...
	Для Каждого СвойстваОбъекта из Документ.Метаданные().Движения Цикл
		...
		РезультирующийДокумент.НачатьГруппуСтрок();
		Построитель.Вывести(РезультирующийДокумент);
		РезультирующийДокумент.ЗакончитьГруппуСтрок();
	КонецЦикла;
	РезультирующийДокумент.ОтображатьГруппировки = истина;
