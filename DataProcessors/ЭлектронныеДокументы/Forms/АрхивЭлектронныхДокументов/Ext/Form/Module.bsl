...
Процедура УстановитьОтветственного(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("УстановитьОтветственногоЗавершение", ЭтаФорма);
	ОткрытьФорму(
...
&НаКлиенте
Процедура УстановитьОтветственногоЗавершение(Результат, ДополнительныеПараметры) Экспорт
	
	НовыйОтветственный = Результат;
