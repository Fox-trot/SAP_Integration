...
&НаКлиенте
Процедура СпособЗагрузкиОбновленийПоИсходящимДокументамПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьОбменЭД"
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ОткрытьПомощникПодключенияКСервисуVenkonЭДО",		  "Доступность", ВключеныЭДиЭП);
		
		//ЭтоПолноправныйПользователь = ЭтоПолноправныйПользователь();
